...
Attributes:
    ...
    number_of_instances: counts the number_of_instances
"""
...
class Rectangle:
    ...
    Rectangle represents a rectangle object.
        Attribute:
            ...
            print_symbol: is the symbole to print the rectangle with
    """
    ...
    def __init__(self, width=0, height=0):
        ...
        Args:
            width: The width of the rectangle.
            height: The height of the rectangle.
            number_of_instances: increment the number of instances
        """
        self.width = width
        self.height = height
    ...
    def __str__(self):
        if self._width == 0 or self._height == 0:
            ...
            for _ in range(self._height):
                shape.append(self.print_symbol * self._width)
            return "\n".join(shape)
